          ...
          <div class="p-4 sm:p-7">
            <div class="text-center">
              ...
              <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <a wire:navigate class="font-medium text-blue-600 decoration-2 hover:underline dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/login">
                  Sign in here
                </a>
              </p>
            </div>
            ...
            <div class="mt-5">
              ...
              <form wire:submit.prevent='save'>
                @if (session('success'))
                <div class="p-4 mt-2 mb-4 text-sm text-white bg-green-500 rounded-lg" role="alert">
                    {{ session('success') }}
                </div>
                @endif
