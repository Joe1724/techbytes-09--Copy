...
<div>
    ...
    <div id="gallery" class="relative w-full" data-carousel="slide">
        <!-- Carousel wrapper -->
        <div class="relative w-full overflow-hidden bg-purple-400 rounded-lg h-96 md:h-96">
            <!-- Item 1 -->
            <div class="duration-700 ease-in-out" data-carousel-item>
                <img src="/images/techbytescom.png" class="absolute block h-auto max-w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
            </div>
            <!-- Item 2 -->
            ...
            <!-- Item 4 -->
            <div class="duration-700 ease-in-out" data-carousel-item>
                <img src="/images/HalloweenSale.jpg" class="absolute block h-auto max-w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
            </div>
            <!-- Item 5 -->
            <div class="duration-700 ease-in-out" data-carousel-item>
                <img src="/images/BigSale.png" class="absolute block h-auto max-w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
            </div>
        </div>
        <!-- Slider controls -->
  ...
  <script>
    ...
    {{-- Hero Section Start --}}
    <div>
        <div class="w-full h-screen px-4 py-10 mx-auto bg-cover sm:px-6 lg:px-8" style="background-image: url('/images/gadgets.png');">
          ...
          <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-white sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                <span class="text-white"><img class="w-full rounded-md" src="/images/logoko.png" alt="image"></span><p class="mt-3 text-lg text-gray-800 dark:text-gray-400"></p>

              <!-- Buttons -->
              {{-- <div class="grid w-full gap-3 mt-7 sm:inline-flex">
                <a class="inline-flex items-center justify-center px-4 py-3 text-sm font-semibold text-white bg-blue-600 border border-transparent rounded-lg gap-x-2 hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/register">
                  Get started
              ...
              <div class="grid grid-cols-2 mt-6 lg:mt-10 gap-x-5">
                ...
                <div class="py-5">
                  <div class="flex space-x-1">
                    <svg class="w-4 h-4 text-gray-800 dark:text-gray-200" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="py-5">
                  ...
                  <div class="mt-5">
                    <!-- Star -->
                    {{-- <svg class="w-16 h-auto text-gray-800 dark:text-white" width="110" height="28" viewBox="0 0 110 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
            ...
            <div class="relative ms-4">
              ...
              <div class="absolute inset-0 -z-[1]  w-full h-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6 dark:from-slate-800 dark:via-slate-900/0 dark:to-slate-900/0"></div>
    ...
    {{-- Hero Section End --}}
      ...
      {{-- Brand Section Start --}}
      <section class="bg-purple-300 bg-opacity-75 py-14 font-poppins">
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold dark:text-purple-200"> Browse Popular<span class="text-black-900"> Brands
                </span> </h1>
            ...
            <p class="mb-12 text-base text-center text-black">
                Your Trusted Hub for Top Brands, Elevating Your Tech Experience with Quality and Innovation. Discover the latest from the brands you love, ensuring every purchase is a step into excellence
            </p>
          </div>
        </div>
      ...
      <div class="bg-purple-400 bg-opacity-75 py-14 font-poppins">
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold dark:text-gray-200"> Browse <span class="text-black-500"> Categories
                </span> </h1>
              <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
            ...
            <p class="mb-12 text-base text-center text-black-500">
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
          <div class="grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-6">
            ...
            <a class="flex flex-col transition bg-white border shadow-sm group rounded-xl hover:shadow-md dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/products?selected_category[0]={{ $categories->id }}" wire:key="{{  $categories->id }}">
                <div class="p-4 md:p-5">
                  <div class="flex items-center justify-between">
                    <div class="flex items-center">
                      <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{ url('storage', $categories->image) }}" alt="{{ $categories->name }}">
                      <div class="ms-3">
      ...
      <section class="w-full h-screen px-4 py-10 mx-auto bg-gradient-to-r from-gray-100 to-purple-500 sm:px-6 lg:px-8">
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
          <div class="max-w-xl mx-auto">
            <div class="text-center ">
              <div class="relative flex flex-col items-center">
                <h1 class="text-5xl font-bold dark:text-gray-200"> Customer <span class="text-black-900"> Reviews
                  </span> </h1>
                <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                  <div class="flex-1 h-2 bg-purple-200">
                  </div>
          ...
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
              ...
              <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
                <div class="flex items-center px-6 mb-2 md:mb-0 ">
                  <div class="flex mr-2 rounded-full">
                    <img src="/images/jham.jpg" alt="" class="object-cover w-12 h-12 rounded-full">
                  </div>
                  <div>
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-300">
                      Jhamyca Galagate Pandiño</h2>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Artist</p>
                  </div>
                </div>
                <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 20, June , 2020
                </p>
              </div>
            ...
            <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
              <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
                <div class="flex items-center px-6 mb-2 md:mb-0 ">
                  <div class="flex mr-2 rounded-full">
                    <img src="https://i.postimg.cc/L5TTNH1q/skrj.jpg" alt="" class="object-cover w-12 h-12 rounded-full">
                  </div>
                  <div>
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-300">
                     SK Rj Narciso</h2>
                    <p class="text-xs text-gray-500 dark:text-gray-400">SK Kagawad</p>
                  </div>
                </div>
                <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 14, SEP , 2020
                </p>
              </div>
              <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                User Friendly, and easy to order.
              </p>
              <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                <div class="flex px-6 mb-2 md:mb-0">
                  <ul class="flex items-center justify-start mr-4">
