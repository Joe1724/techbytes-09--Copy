...
<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
      <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
        ...
        <div class="flex flex-wrap -mx-4" style="z-index: 20%">
            ...
            <div class="lg:pl-20">
              ...
              <div class="mb-8 [&ul]:list-disc [&ul]:ml-4">
                <h2 class="max-w-xl mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl">
                  {{ $product->name }}</h2>
                <p class="inline-block mb-6 text-4xl font-bold text-red-700 dark:text-gray-400 ">
              ...
              <div class="flex flex-wrap items-center gap-4">
                ...
                <span wire:laading wire:target='addToCart({{ $product->id }})'></span>
                </button>
              </div>
            </div>
          </div>
